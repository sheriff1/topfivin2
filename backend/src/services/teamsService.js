...
async function getTeamStats(teamId, season, db) {
  ...
  return {
    ...
    stats: {
      ...
      fga: team.fga,
      fg_pct: team.fg_pct,
      three_p: team.three_p,
      three_pa: team.three_pa,
      three_p_pct: team.three_p_pct,
      ft: team.ft,
      fta: team.fta,
      ft_pct: team.ft_pct,
      oreb: team.oreb,
      ...
      pts: team.pts,
      fg_avg: team.fg_avg,
      fga_avg: team.fga_avg,
      three_p_avg: team.three_p_avg,
      reb_avg: team.reb_avg,
      ast_avg: team.ast_avg,
      tov_avg: team.tov_avg,
